package com.mohamedsamir1495.eventbookingsystem.exception;

import com.mohamedsamir1495.eventbookingsystem.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler  extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleDomainException(DomainException exception, WebRequest webRequest) {
        ErrorResponseDto errorResponseDTO = new ErrorResponseDto(
                ((ServletWebRequest) webRequest).getRequest().getServletPath(),
                exception.getStatus(),
                exception.getMessage(),
